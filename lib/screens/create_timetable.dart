...
import 'package:timetable/screens/lesson_container_popup.dart';
...
class _CreateTimetableScreenState extends State<CreateTimetableScreen> {
  // List<EditLessonContainerScreen> _lessonContainerScreens = [];
      ...
      child: TextButton(
        onPressed: () {
          showModalBottomSheet(
            context: context,
            builder: (context) => const LessonContainerPopUp(),
          );
        },
